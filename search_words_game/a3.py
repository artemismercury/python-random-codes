...
def is_valid_word(wordlist, word):
    ...
    True
    >>> is_valid_word(['ANT', 'BOX', 'SOB', 'TO'], 'AR')
    False
    >>> is_valid_word(['AMERICA', 'ENGLAND', 'UK'], 'MERICA')
    False
    """
...
def make_str_from_column(board, column_index):
    ...
    for car in board:
        string = string + board[index][column_index]
        index = index + 1
...
def num_words_on_board(board, words):
    ...
    3
    >>> num_words_on_board([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B']], ['ANT', 'NO', 'SO', 'TO'])
    3
    >>> num_words_on_board([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B']], ['AX', 'NO', 'SO'])
    2
    """
...
def read_board(board_file):
    ...
    list_of_strings = [word for line in board_file for word in line.split()]
